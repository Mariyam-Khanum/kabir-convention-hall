...
<body>
	...
	if ($troom == "Reception") {
		$type_of_room = 320;
	} else if ($troom == "Birthday") {
		$type_of_room = 220;
	} else if ($troom == "Wedding") {
		$type_of_room = 180;
	} else if ($troom == "Engagement") {
		$type_of_room = 150;
	} else if ($troom == "Naming Ceremony") {
		$type_of_room = 150;
	} else if ($troom == "Baby Showerment") {
		$type_of_room = 150;
	} else if ($troom == "other") {
		$type_of_room = 150;
	}
	...
	<header>
		...
		<span><img alt="" src="../image/bluebirdlogo.png"></span>
	</header>
	<article>
		<h1>Recipient</h1>
		<address>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- Kabirconventionhall@gmail.com || Web :- www.Kabir Convention Hall.com || Phone :- +91 9313346569 </p>
		</div>
	</aside>
